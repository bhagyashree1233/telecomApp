...
{name:"RELIANCE-CDMA",src:'../relianc.jpg'},
...
$scope.dthRecharge=[
{name:'Dish TV DTH',src:'../dish.png'},
{name:'Tata Sky DTH',src:'../sky.png'},
{name:'Big TV DTH',src:'../bigTV.jpg'},
{name:'Videocon DTH',src:'../videcon.png'},
{name:'Sun DTH',src:'../sun.png'},
{name:'Airtel DTH',src:'../airtelDTH.png'}
]
$scope.postPaidRecharge=[
{name:'POSTPAID AIRTEL',src:'../airtel.jpg'},
{name:'POSTPAID IDEA',src:'../idea.jpg'},
{name:'POSTPAID VODAFONE',src:'../vodafone.jpg'},
{name:'POSTPAID BSN',src:'../bsnl.jpg'},
{name:'POSTPAID DOCOMO',src:'../docomo.jpg'},
{name:'POSTPAID RELICE CDMA/GSM',src:'../relianc.jpg'}
]
